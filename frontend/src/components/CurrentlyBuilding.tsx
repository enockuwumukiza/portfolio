...
const BUILDS = [
  {
    label: 'HandyRwanda',
    detail: 'Sprint 13 — offline-first job posting shipped',
  ...
  {
    label: 'CropMind',
    detail: 'Offline TFLite crop disease diagnosis for farmers',
    href: 'https://github.com/Enochrwa/CropMind',
    sprint: 'Active',
    color: 'from-accent/90 to-primary/80',
  },
  {
    label: 'eCyber',
    detail: 'ML intrusion detection + Electron security dashboard',
    href: 'https://github.com/Enochrwa/ecyber-system',
    sprint: 'Active',
    color: 'from-primary/80 to-accent/90',
  },
  {
    label: 'SOMA Market',
    detail: 'MTN MoMo payments + Kinyarwanda i18n',
    href: 'https://github.com/Enochrwa/soma-connect',
    sprint: 'Active',
    color: 'from-accent/90 to-primary/80',
  },
];
