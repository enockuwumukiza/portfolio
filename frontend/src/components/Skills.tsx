...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'MongoDB', usedIn: ['eChat', 'SOMA Market'], level: 'proficient' },
  ...
  },
  {
    ...
    color: 'accent',
    skills: [
      { name: 'Python', usedIn: ['HandyRwanda', 'INZIRA EDRPS', 'AI Wardrobe', 'eCyber'], level: 'core' },
      { name: 'scikit-learn', usedIn: ['HandyRwanda earnings', 'INZIRA EDRPS', 'eCyber IDS'], level: 'core' },
      { name: 'XGBoost', usedIn: ['INZIRA EDRPS', 'CropMind'], level: 'proficient' },
      { name: 'CatBoost', usedIn: ['INZIRA EDRPS'], level: 'proficient' },
      { name: 'LightGBM', usedIn: ['INZIRA EDRPS'], level: 'proficient' },
      { name: 'TensorFlow', usedIn: ['AI Wardrobe'], level: 'proficient' },
      { name: 'TensorFlow Lite', usedIn: ['CropMind on-device'], level: 'proficient' },
      { name: 'Pandas/NumPy', usedIn: ['HandyRwanda', 'INZIRA EDRPS', 'CropMind'], level: 'core' },
  ...
  },
  {
    ...
    color: 'primary',
    skills: [
      { name: 'React Native', usedIn: ['HandyRwanda mobile app', 'CropMind'], level: 'proficient' },
      { name: 'Expo', usedIn: ['HandyRwanda mobile app', 'CropMind'], level: 'proficient' },
      { name: 'Electron', usedIn: ['eCyber desktop app'], level: 'proficient' },
    ],
  },
  {
    title: 'DevOps & Cloud',
